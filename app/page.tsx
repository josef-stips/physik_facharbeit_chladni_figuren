    ...
    <div className="min-h-screen flex justify-center pt-24 sm:pt-32 lg:pt-[8vh]">
      ...
      <main className="w-full max-w-5xl px-6 flex flex-col items-center gap-[6vh]">
        ...
        <p className="text-xl leading-8 text-zinc-600 dark:text-zinc-400 text-center">
          Chladni Figuren sind wahrlich einer der faszinierensten Beobachtungen der Physik. Sie wurden nach &quot;Ernst Florens Friedrich Chladni&quot; benannt, der sie um 1800 in Europa bekannt machte.
          Erst bis zum Jahre 1909 wurde die theoretische Grundlage für Chladnische Klangfiguren vollständig erarbeitet und seit dem nicht weiter aufgegriffen was die Figuren bis heute interessant macht. 
          Sie entstehen auf einer mit Sand oder Salz bestreuten Platte die mit einer Frequenz resoniert. Jede Frequenz besitzt ihre eigene einzigartige Chladni-Figur wobei die Figuren umso 
          komplexer werden umso höher die Frequenz ist.
        </p>
